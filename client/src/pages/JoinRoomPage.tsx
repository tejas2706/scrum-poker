...
export function JoinRoomPage() {
  ...
  const validate = () => {
    ...
    if (!formData.roomId.trim()) {
      ...
      newErrors.roomId = 'Room ID must be at least 4 characters';
    }
  ...
  const isFormValid = formData.roomId.trim().length >= 4 && 
    ...
    <div className="mx-auto max-w-lg px-4 sm:px-6 pt-20 sm:pt-24 pb-12 sm:pb-20">
      ...
      >
        ...
        <Typography variant="body" className="text-surface-600 dark:text-surface-400">
          Enter the room ID to join an existing planning poker session.
        </Typography>
          ...
          <form onSubmit={handleSubmit}>
            <CardContent className="space-y-6 pt-6">
              <Input
                ...
                error={errors.roomId}
                helperText="Enter the room ID provided by the room creator"
